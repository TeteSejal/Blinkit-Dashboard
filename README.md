...
Short Description: 
A comprehensive data visualization dashboard designed to analyze retail sales performance for "Blinkit." It tracks key performance indicators (KPIs) such as total revenue, average sales, and customer ratings across different outlet types, sizes, and locations to drive data-informed business decisions.


Tech Stack:
Data Visualization: Power BI or Tableau (indicated by the slicers and interactive chart types).
Data Source: Structured datasets (e.g., CSV, Excel, or SQL database) containing retail transaction records.
Analysis: DAX (Data Analysis Expressions) for custom metrics or Python/R for data cleaning.
